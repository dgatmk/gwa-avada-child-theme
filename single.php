	...
	<?php while ( have_posts() ) : the_post(); ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
			...
			<div class="post-content">
				...
				<?php $file = get_field('pdf_file'); if ( $file ) : $url = $file['url']; ?>
					<a class="fusion-button button-flat button-square button-medium button-default button-1" href="<?php echo $url ?>" target="_blank" style="">Download This Article</a>
				<?php endif; ?>
			</div>
